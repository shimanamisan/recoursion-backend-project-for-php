 ...
 * ファイルの内容を二重にするクラス
 */
class DuplicateContents implements IFileOperation
{
    ...
    */
    public function __construct($inputFile, $replicationCount)
    {
    ...
    public function execute(): void
    {
        try {
            ...
            // 読み取った内容を指定した回数分追記
            for($i = 0; $i < $this->replicationCount; $i++) {
                fwrite($this->handle, "\n{$readContents}");
            }
